<template>
  <el-card style="margin: 10px;padding: 15px 10px 10px 10px">
    <el-row style="margin-bottom: 10px">
      <el-button type="primary" size="small" @click="addMethod">打卡</el-button>
      ...
      <el-input style="float:right;width:300px;" size="small" v-model="searchValue.code" placeholder="请输入学号或姓名或专业" clearable @keyup.enter.native="filterData">
        <el-button slot="append" @click="filterData" type="primary">搜索</el-button>
      </el-input>
    </el-row>
    <VmBaseTable
      :setTableHigh="true"
...
<script>
  import VmStudent from './model/attence-model'
    ...
    methods: {
      search() {
        ...
        this.axiosHelper.get(
          '/api/sms/attendance/getAttendanceList',
