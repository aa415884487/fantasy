<template>
  <div>
    <el-menu
      ...
      <el-menu-item index="attence" :class="{active: $route.name === '学生考勤'}">
        <i class="el-icon-s-order"></i>
        <span slot="title">&#12288学生考勤</span>
      </el-menu-item>
      ...
      <el-submenu index="setting" v-if="level === 0">
        ...
        <el-menu-item-group>
          <el-menu-item index="department" :class="{active: $route.name === '学院管理'}">
            <span slot="title">学院管理</span>
          </el-menu-item>
        </el-menu-item-group>
        <el-menu-item-group>
          <el-menu-item index="" :class="{active: $route.name === '专业管理'}">
